 ...
 * @author Alejandro
 */
public class FVerInmueblesReservadosAnfitrion extends javax.swing.JFrame {

    /**
     * Creates new form F_InmueblesReservadosAnfitrion
     */
    public FVerInmueblesReservadosAnfitrion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Inmuebles reservados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FVerInmueblesReservadosAnfitrion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FVerInmueblesReservadosAnfitrion().setVisible(true);
            }
        });
    }
