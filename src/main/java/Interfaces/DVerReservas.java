 ...
 * @author Alejandro
 */
public class DVerReservas extends javax.swing.JFrame {

    /**
     * Creates new form D_VerReservas
     */
    public DVerReservas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DVerReservas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DVerReservas().setVisible(true);
            }
        });
    }
