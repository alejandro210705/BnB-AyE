 ...
 * @author Alejandro
 */
public class EVerMisReservas extends javax.swing.JFrame {

    /**
     * Creates new form E_VerMisReservas
     */
    public EVerMisReservas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EVerMisReservas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EVerMisReservas().setVisible(true);
            }
        });
    }
