 ...
 * @author Alejandro
 */
public class AAA_PanelDatosAnfitrion extends javax.swing.JFrame {

    /**
     * Creates new form AA_PanelDatosBnB
     */
    public AAA_PanelDatosAnfitrion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AAA_PanelDatosAnfitrion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AAA_PanelDatosAnfitrion().setVisible(true);
            }
        });
    }
